    ...
    <div class="flex justify-center">
      <div :class="isMobile">
        ...
        <div class="q-mt-md flex justify-center text-uppercase text-caption">
          <q-tabs v-model="shop" active-color="white" no-caps dense class="bg-warning text-white shadow-2 fit"  style="border-radius: 5px;" >
            <q-tab name="itens" icon="img:https://image.flaticon.com/icons/png/128/4665/4665249.png" label="Inventário"/>
            <q-tab name="equipamentos" icon="img:https://img-premium.flaticon.com/png/512/1734/1734158.png?token=exp=1621052389~hmac=938a35b31581276c78299840ffc93856" label="Missões"/>
            <q-tab name="equipamentos" label="Armamentos">
